...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Support
{
        ...
        System.IEquatable<Status>
    {
        ...
        /// <summary>New status to inform admins that the endpoint is currently provisioning.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Support.Status Provisioning = @"Provisioning";

        /// <summary>New status to inform admins that provisioning failed on the endpoint.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Support.Status ProvisioningFailed = @"ProvisioningFailed";
